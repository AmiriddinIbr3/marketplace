...
const (
	SmsService_SendSmsOnPhone_FullMethodName = "/sms.SmsService/SendSmsOnPhone"
)
...
type SmsServiceClient interface {
	SendSmsOnPhone(ctx context.Context, in *SendSmsOnNumber, opts ...grpc.CallOption) (*SendedSms, error)
}
...
func (c *smsServiceClient) SendSmsOnPhone(ctx context.Context, in *SendSmsOnNumber, opts ...grpc.CallOption) (*SendedSms, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendedSms)
	err := c.cc.Invoke(ctx, SmsService_SendSmsOnPhone_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SmsServiceServer interface {
	SendSmsOnPhone(context.Context, *SendSmsOnNumber) (*SendedSms, error)
...
func (UnimplementedSmsServiceServer) SendSmsOnPhone(context.Context, *SendSmsOnNumber) (*SendedSms, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendSmsOnPhone not implemented")
}
...
func _SmsService_SendSmsOnPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendSmsOnNumber)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SmsServiceServer).SendSmsOnPhone(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SmsService_SendSmsOnPhone_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SmsServiceServer).SendSmsOnPhone(ctx, req.(*SendSmsOnNumber))
	}
...
var SmsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendSmsOnPhone",
			Handler:    _SmsService_SendSmsOnPhone_Handler,
		},
	},
