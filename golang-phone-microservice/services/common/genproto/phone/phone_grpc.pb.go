...
const (
	PhoneService_CheckPhone_FullMethodName = "/phone.PhoneService/checkPhone"
)
...
type PhoneServiceClient interface {
	CheckPhone(ctx context.Context, in *ValidPhoneByNumber, opts ...grpc.CallOption) (*ValidatedPhone, error)
}
...
func (c *phoneServiceClient) CheckPhone(ctx context.Context, in *ValidPhoneByNumber, opts ...grpc.CallOption) (*ValidatedPhone, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ValidatedPhone)
	err := c.cc.Invoke(ctx, PhoneService_CheckPhone_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PhoneServiceServer interface {
	CheckPhone(context.Context, *ValidPhoneByNumber) (*ValidatedPhone, error)
...
func (UnimplementedPhoneServiceServer) CheckPhone(context.Context, *ValidPhoneByNumber) (*ValidatedPhone, error) {
...
func _PhoneService_CheckPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PhoneService_CheckPhone_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PhoneServiceServer).CheckPhone(ctx, req.(*ValidPhoneByNumber))
	}
